### Normal model of lightspeed

*Lightspeed* estimates a linear normal model without predictors. The data are 66 measurements from Simon Newcomb and represent the time required for light to travis roughly 7500 meters.
