...
Total population size, abundance at each time $t$, and the number of recruits can be estimated from the posterior estimates of $\psi$, $\phi$, $b$, and $p$. This calculation is included in the `generated quantities` block of the Stan code, below.
