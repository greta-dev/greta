...
# Only evaluate TensorFlow code off CRAN. reticulate now auto-installs TF via
# uv, so `check_tf_version()` alone no longer prevents these chunks running (and
# installing TF) on CRAN.
.eval_tf <- identical(tolower(Sys.getenv("NOT_CRAN")), "true") &&
  greta:::check_tf_version("message")
