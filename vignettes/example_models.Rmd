...
```{r child='examples/multiple_linear_lasso.Rmd'}
```

<hr>

```{r child='examples/multiple_linear_warpbreaks.Rmd'}
```

<hr>

```{r child='examples/multiple_linear_multilogit.Rmd'}
```
...
```{r child='examples/hierarchical_linear_slopes.Rmd'}
```
...
```{r child='examples/linear_uninformative.Rmd'}
```

<hr>

```{r child='examples/linear_ridge.Rmd'}
```

<hr>

```{r child='examples/linear_lasso.Rmd'}
```

<hr>

```{r child='examples/linear_spike_and_slab.Rmd'}
```

<hr>

```{r child='examples/linear_horseshoe.Rmd'}
```

<hr>

```{r child='examples/linear_finnish_horseshoe.Rmd'}
```

<hr>

```{r child='examples/linear_ponyshoe.Rmd'}
```

## Advanced Baysian models

<hr>

```{r child='examples/hierarchical_linear_general.Rmd'}
```

<hr>

```{r child='examples/hierarchical_linear_marginal.Rmd'}
```

<hr>

```{r child='examples/bayesian_neural_network.Rmd'}
```
...
```{r child='examples/lightspeed.Rmd'}
```

<hr>

```{r child='examples/eight_schools.Rmd'}
```
