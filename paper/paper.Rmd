...
Note: 
* Tell me why it is called greta?
* Tell me what the rest of the paper is - why use an example?
...
Before we specify the greta model, we format the data to make our lives
...
Next we build a model for the effects (the ratio of post-treatment to
...
(note: you have mentioned greta arrays here but define them in full later - perhaps might be worthwhile to discuss earlier?)
...
Note: Did you want to link to references for `greta.gp`, `greta.gam` etc?
