...
* The `SystemRequirements` field in `DESCRIPTION` now names the versions greta actually needs — Python 3.9 or later, TensorFlow 2.15.0 up to 2.21.0, and TensorFlow Probability 0.23.0 or later — rather than the far older Python 3.7.0, TensorFlow 2.0.0 and TensorFlow Probability 0.8.0 it listed before, and it now records the TensorFlow ceiling that greta enforces (#810).
