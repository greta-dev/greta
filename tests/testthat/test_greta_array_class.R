...
test_that("print and summary work", {
  ...
  # summary method
  expected_output <- paste0(
    "'data' greta array with 9 elements (3 x 3)  \n\n",
    "       V1            V2            V3     \n Min.",
    "   :1.0   Min.   :4.0   Min.   :7.0  \n 1st",
  ...
  expected_output <- paste(
    "greta array (variable following a normal",
    "distribution)\n\n     [,1]\n[1,]  ?  "
  )
  ...
  # summary method
  expected_output <- paste(
    "'variable' greta array with 1 element following",
  ...
  # summary method
  expected_output <- paste0(
    "'operation' greta array with 9 elements (3 x 3)",
