...
The following example fits a large hierarchical linear regression model using `greta`.

First we create a large (10,000 observations, 100 covariates) fake dataset:
...
With the model defined, we can start drawing samples of the parameters we care about. This runs in around a minute on my laptop. It should go much faster if you run it on a GPU!
