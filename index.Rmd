...
#head {
  background: #B797D7 url(../logos/greta-header.png) 0 45% / cover no-repeat;
...
<img id="main-icon" src="../logos/main_icon.png" />
...
<div class="col-md-5">
&thinsp; <span class="fa fa-arrow-circle-right fa-2x" style="vertical-align:middle;"></span>&emsp; [get started](articles/get_started.html)
</div>
