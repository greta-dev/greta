...
<div class="row">
<img id="main-icon" src="images/main-icon.png" />
</div>
<div class="row">
...
<div class="col-md-4">
  <span class="fa fa-code fa-2x" style="vertical-align:middle;"></span>
  <a href="#example">basic example</a>
</div>


<div class="col-md-4">
  <span class="fa fa-arrow-circle-right fa-2x" style="vertical-align:middle;"></span>
...
<div class="col-md-4">
  <span class="fa fa-file-code-o fa-2x" style="vertical-align:middle;"></span>
  [example models](example_models.html)
</div>


<div class="col-md-4">
  <span class="fa fa-book fa-2x" style="vertical-align:middle;"></span>
  [package docs](reference-index.html)
</div>
...
## TODO: Change warmup and n_samples back to 1000
draws <- mcmc(m, warmup = 100, n_samples = 100, chains = 3)
