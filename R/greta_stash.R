...
#'
#' @description These functions retrieve installation or error information
#'   output by python when running `install_miniconda()`, `conda_create()`,
#'   `conda_install()`, or when encountering a TensorFlow numerical problem.
#'
#' @rdname stash-notes
#' @export
#' @examples
